import pandas as pd
from retriever_finetuning.prompts import system_prompt
from retriever_finetuning.llm import run_chat_completion

prompts_df = pd.read_csv("retriever_finetuning/prompts.csv")
...
for i, p in enumerate(prompts):
    ...
    if (i + 1) % 20 == 0:
        ...
        out.to_csv("./retriever_finetuning/questions.csv", index=False)
