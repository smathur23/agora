...
def finetune(name, input_file, output_dir, negs=True, add_negs=False):
    ...
    with open(f"retriever_finetuning/{input_file}", "r") as f:
        for line in f:
...
if __name__ == "__main__":
    # Ragatouille will break if you try to do more than 1 finetuning in one run. Uncomment one function call at a time
