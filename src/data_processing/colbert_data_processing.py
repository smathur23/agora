...
# Can be used to create chunks that are whole documents - not used currently 
...
def create_colbert_index():
    ...
    index_name, map_path = generate_colbert_embeddings(chunks) # add arguments for fine-tuned model name and index name here
